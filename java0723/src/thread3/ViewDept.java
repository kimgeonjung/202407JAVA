...
public class ViewDept extends JFrame {
	...
	ViewDept() {
		...
		Thread thread = new Thread(clockPanel);
		thread.start();
		con.add(clockPanel, BorderLayout.SOUTH);
		...
		bt.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					if (flag) {
						JOptionPane.showMessageDialog(jf,"해당 자료없습니다.","정보", 
