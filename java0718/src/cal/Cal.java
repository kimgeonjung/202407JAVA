...
public class Cal extends JFrame {
	...
	public Cal() {
		...
		plus.addActionListener(new MyListner());
		minus.addActionListener(new MyListner());
		multiply.addActionListener(new MyListner());
		divide.addActionListener(new MyListner());
